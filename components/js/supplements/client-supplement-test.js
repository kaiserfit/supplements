...
var stripe = Stripe('pk_test_51Id2gRBVqVZ2ueLqtIH9GclmrHJII2dhR7s8iGJqGsaOzukryligGXvYNnMkS4nomXb5rAAw8mZYmOrJxHtinU2Z00J4rsWz7z');
...
function stripeTokenHandler(token) {
  ...
  $.ajax({
    type: 'POST',
    url: 'https://queenformula.net/api/fbc.php',
    crossDomain: true,
    data: dd,
    dataType: 'json',
