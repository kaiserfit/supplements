...
$(".goalButton").click(function() {
  ...
  $("#quiz1").hide();
    ...
    window.location.href = "/stage/vsl-result.html";
}, 2000);
});
...
$(".wGoButton").click(function() {
 ...
 setTimeout(function() {
  ...
  $("#quiz2").hide();
     window.location.href = "/stage/vsl-quiz-result-2";
...
$(".insButton").click(function() {
 ...
 setTimeout(function() {
  ...
  $("#quiz3").hide();
window.location.href = "/stage/vsl-quiz-result-3";
...
$(".ssButton").click(function() {
 ...
 setTimeout(function() {
  ...
  $("#quiz4").hide();
   window.location.href = "/stage/vsl-quiz-result-4";
}, 2000);
});
